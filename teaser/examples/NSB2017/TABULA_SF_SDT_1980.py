...
def example_create_building():
    ...
    prj.name = "NSB_TABULA_SDT" #ADD
    bldg = Building(parent=prj)

    '''Set some building parameters'''
    bldg.name = "TABULA_SF_SDT_1980" #ADD
    ...
    tz.area = 185.3 #ADD
    tz.volume = 509.6 #ADD
    tz.infiltration_rate = 5 #ADD old tabula 12.5
